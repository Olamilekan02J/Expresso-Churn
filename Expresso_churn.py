...
st.markdown("<h1 style = 'color: #45474B; text-align: center;font-family: Arial, Helvetica, sans-serif; '>EXPRESSO PROJECT</h1>", unsafe_allow_html= True)
st.markdown("<h3 style = 'margin: -25px; color: #45474B; text-align: center;font-family: Arial, Helvetica, sans-serif; '> BUILT BY OLAMILEKAN</h3>", unsafe_allow_html= True)
...
if st.button('Press To Predict'):
    ...
    st.image('pngwing.com.png', width = 200)
